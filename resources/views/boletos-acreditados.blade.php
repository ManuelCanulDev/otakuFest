                                            ...
                                            <tr>
                                                <td valign="top"
                                                    ...
                                                    <h1
                                                        ...
                                                        TUS BOLETOS HAN SIDO ACREDITADOS</h1>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top"
                                                    style="text-align: center; padding: 10px 20px 15px 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #fff;">
                                                    <p style="margin: 0;">A continuación entrarás el enlace para asignar los nombres de tus boletos y poder descargarlos. EXITO NAKAMA.</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <tr>
                                <td style="padding: 40px 40px 5px 40px; text-align: center;">
                                    <h1
                                        ...
                                        SOLAMENTE QUEDA QUE ASIGNES LOS NOMBRES A TUS BOLETOS :D</h1>
                                </td>
                            </tr>
                            <tr>
                                <td
                                    ...
                                    <p style="margin: 0;">Recuerda que el nombre que tiene que asignar, debe ser el que aparece en la identificación oficial (INE, Licencia, Cartilla Militar, Cedula).</p>
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <table role="presentation" align="center" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td style="border-radius: 50px; background: #ffffff; text-align: center;"
                                                class="button-td"> <a href="{{ env('APP_URL') }}/asignar-boletos/{{$uid}}"
                                                    ...
                                                    class="button-a"> <span style="color:#26a4d3;"
                                                        class="button-link">CLICK AQUÍ</span> </a> </td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
