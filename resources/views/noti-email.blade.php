...
<body style="background-color:#eaeaea;">
    <div
        ...
        Preview - Notificacion Otaku Fest </div>
    ...
    <![endif]-->
      ...
      <![endif]-->
        <div style="background:url(https://i.gifer.com/O8zb.gif">
            <div style="line-height:0;font-size:0;">
                <table role="presentation"
                    style="background:url(https://i.gifer.com/O8zb.gif) top center / cover no-repeat;width:100%;border-radius:20px 20px 0 0;"
                    cellspacing="0" cellpadding="0" border="0" background="https://i.gifer.com/O8zb.gif"
                    align="center">
                    <tbody>
                        <tr>
                            <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;">
          ...
          <![endif]-->
                                <div class="mj-column-per-100 mj-outlook-group-fix"
                                    ...
                                    <table role="presentation" style="vertical-align:top;" width="100%"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="font-size:0px;padding:8px 0;word-break:break-word;"
                                                    align="center">
                                                    <table role="presentation"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="width:150px;">
                                                                    <img src="https://i.ibb.co/pnz1Wxd/Logo-Negro.png"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="font-size:0px;padding:10px 25px;word-break:break-word;"
                                                ...
                                                <div
                                                    style="font-family:Nunito, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:20px;text-align:left;color:#54595f;">
                                                    <p style="margin: 5px 0;">Hola {{ $nombre_destino }}, </p>
                                                    <p style="margin: 5px 0;">{{ $texto }}</p>
                                                </div>
                                            </td>
                                        </tr>
                                        @if ($url != '')
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td role="presentation"
                                                                    ...
                                                                    valign="middle" bgcolor="#54595f" align="center">
                                                                    <a href="{{$url}}"
                                                                        style="display: inline-block; background: #54595f; color: white; font-family: Nunito, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 30px; margin: 0; text-decoration: none; text-transform: none; padding: 10px 25px; mso-padding-alt: 0px; border-radius: 30px;"
                                                                        target="_blank"> ENTRA AQUÍ </a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                        ...
                                        <tr>
                                            <td style="font-size:0px;padding:10px 25px;word-break:break-word;"
                                                ...
                                                <div
                                                    style="font-family:Nunito, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:20px;text-align:left;color:#54595f;">
                                                    <p style="margin: 5px 0;">¡Estamos ansiosos por verte!</p>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-size:0px;padding:10px 25px;word-break:break-word;"
                                                ...
                                                <div
                                                    style="font-family:Nunito, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:20px;text-align:left;color:#54595f;">
                                                    <p style="margin: 5px 0;">Gracias, <br /> Otaku Fest, Organizadores
                                                        y Patrocionadores.</p>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="font-size:0px;padding:10px 25px;word-break:break-word;"
                                                ...
                                                <div
                                                    ...
                                                    Todos los Derechos Reservados Manuel Canul Dev.
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
